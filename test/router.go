...
import (
	...
	"github.com/COMTOP1/AFC-GO/test/views"
)
...
func (r *Router) Start() error {
	r.router.Logger.Error(r.router.Start("0.0.0.0:8888"))
	return fmt.Errorf("failed to start router on address")
}
