...
func (t *Templater) RenderTemplate(w io.Writer, data interface{}, mainTmpl Template, templateType TemplateType) error {
	...
	case RegularType:
		t1, err = t1.ParseFS(tmpls, "_base.tmpl", "_top.tmpl", "_footer.tmpl", "_logoutModal.tmpl", "_loginModal.tmpl", "_pell.tmpl", mainTmpl.String())
	default:
...
var (
	AllTemplates = [][]string{
		...
		{"infoEdit.tmpl", "_base.tmpl", "_top.tmpl", "_footer.tmpl", "_logoutModal.tmpl", "_loginModal.tmpl"},
