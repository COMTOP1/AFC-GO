...
func (v *Views) DownloadFunc(c echo.Context) error {
	...
	case "a": // Affiliation
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for affiliation download: no such file")
			}
			return fmt.Errorf("failed to get file for affiliation download: %w", err)
		}
	...
	case "d": // Document
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for document download: no such file")
			}
			return fmt.Errorf("failed to get file for document download: %w", err)
		}
	...
	case "g": // Gallery
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for image download: no such file")
			}
			return fmt.Errorf("failed to get file for image download: %w", err)
		}
	...
	case "l": // Player
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for player download: no such file")
			}
			return fmt.Errorf("failed to get file for player download: %w", err)
		}
	...
	case "n": // News
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for news download: no such file")
			}
			return fmt.Errorf("failed to get file for news download: %w", err)
		}
	...
	case "p": // Programme
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for programme download: no such file")
			}
			return fmt.Errorf("failed to get file for programme download: %w", err)
		}
	...
	case "s": // Sponsor
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for sponsor download: no such file")
			}
			return fmt.Errorf("failed to get file for sponsor download: %w", err)
		}
	...
	case "t": // Team
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for team download: no such file")
			}
			return fmt.Errorf("failed to get file for team download: %w", err)
		}
	...
	case "u": // User
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for user download: no such file")
			}
			return fmt.Errorf("failed to get file for user download: %w", err)
		}
	...
	case "w": // WhatsOn
		...
		if err != nil {
			if strings.Contains(err.Error(), "no such file") {
				return fmt.Errorf("failed to get file for whatson download: no such file")
			}
			return fmt.Errorf("failed to get file for whatson download: %w", err)
		}
